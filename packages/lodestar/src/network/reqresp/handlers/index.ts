...
export class ReqRespHandler implements IReqRespHandler {
  ...
  public async *onStatus(): AsyncIterable<phase0.Status> {
  ...
  public async *onBeaconBlocksByRoot(req: phase0.BeaconBlocksByRootRequest): AsyncIterable<phase0.SignedBeaconBlock> {
